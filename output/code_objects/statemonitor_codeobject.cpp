...
const size_t _numnot_refractory = 1;
    ...
    _dynamic_array_statemonitor_I_0.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_I_1.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_Th_s.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_Th_v.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const double _source_I_0 = _ptr_array_neurongroup_I_0[_idx];
        const double _source_I_1 = _ptr_array_neurongroup_I_1[_idx];
        const double _source_Th_s = _ptr_array_neurongroup_Th_s[_idx];
        const double _source_Th_v = _ptr_array_neurongroup_Th_v[_idx];
        ...
        _dynamic_array_statemonitor_I_0(_new_size-1, _i) = _to_record_I_0;
        _dynamic_array_statemonitor_I_1(_new_size-1, _i) = _to_record_I_1;
        _dynamic_array_statemonitor_Th_s(_new_size-1, _i) = _to_record_Th_s;
        _dynamic_array_statemonitor_Th_v(_new_size-1, _i) = _to_record_Th_v;
