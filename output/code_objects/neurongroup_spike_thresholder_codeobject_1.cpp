...
const size_t _numt = 1;
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const double Th_s = _ptr_array_neurongroup_Th_s_1[_idx];
        const double Th_v = _ptr_array_neurongroup_Th_v_1[_idx];
        const double V = _ptr_array_neurongroup_V_1[_idx];
        const char not_refractory = _ptr_array_neurongroup_not_refractory_1[_idx];
        char _cond;
        if(!not_refractory)
        ...
        if(_cond) {
            _ptr_array_neurongroup__spikespace_1[_count++] = _idx;
            _ptr_array_neurongroup_not_refractory_1[_idx] = false;
            _ptr_array_neurongroup_lastspike_1[_idx] = _ptr_array_defaultclock_t[0];
        }
    }
    _ptr_array_neurongroup__spikespace_1[N] = _count;
